...
namespace carteiraAcoes.Services {
    public class InfoMoneyService : IInfoMoneyService {
        ...
        public async Task<InfoMoneyResultOpcao> pegarOpcoes (string codAcao) {
            ...
            parameters.Add ("cotacoes_opcoes_table_nonce", "3db2dfcd97");
            ...
            try {
                ...
                return JsonSerializer.Deserialize<InfoMoneyResultOpcao> (result.Content.ReadAsStringAsync ().Result,new JsonSerializerOptions
{
