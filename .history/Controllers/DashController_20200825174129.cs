...
namespace carteiraAcoes.Controllers {
  //  [Route ("api/[controller]")]
    ...
    public class DashController : ControllerBase {
        ...
        [HttpGet]
        [Route ("api/LucroMensal")]
        public async Task<LucroMensal> GetLucroMensal () {

            return new LucroMensal() { acoes = await _lucroService.PegarLucroMensalAcao (), opcoes = await _lucroService.PegarLucroMensalOpcao () }
